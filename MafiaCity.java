...
class MafiaCity {
    ...
    public static void generateBusinesses(){
        ...
        newBusinesses.add(new Business(200, "Stealing", "intelligence", metadata.getFileNames(), metadata.getFileItalianLastNames(), metadata.getFileNonItalianLastNames(), metadata.getPersonIds()));
        newBusinesses.add(new Business(450, "Extortion", "charism", metadata.getFileNames(), metadata.getFileItalianLastNames(), metadata.getFileNonItalianLastNames(), metadata.getPersonIds()));
        newBusinesses.add(new Business(300, "Black Market", "strategist", metadata.getFileNames(), metadata.getFileItalianLastNames(), metadata.getFileNonItalianLastNames(), metadata.getPersonIds()));
